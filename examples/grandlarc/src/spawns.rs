...
impl SpawnLocations {
    pub fn new() -> Self {
        let los_santos_locations = vec![
            (Vector3::new(1751.1097, -2106.4529, 13.5469), 183.1979), // El-Corona - Outside random house
            ...
            (Vector3::new(2552.5417, -958.0850, 82.6345), 280.2542), // Random house north of Las Colinas
            ...
            (Vector3::new(2495.0720, -1687.5278, 13.5150), 359.6696), // Outside CJ's house - lots of cars nearby
            (Vector3::new(2306.8252, -1675.4340, 13.9221), 2.6271), // House in ganton - lots of cars nearby
            ...
            (Vector3::new(2015.3630, -1717.2535, 13.5547), 93.3655), // Idlewood house
            ...
            (Vector3::new(842.5260, -1007.7679, 28.4185), 213.9953), // North of Graveyard
            (Vector3::new(911.9332, -1232.6490, 16.9766), 5.2999),  // LS Film Studio
            ...
            (Vector3::new(1240.3170, -2036.6886, 59.9575), 276.4659), // Verdant Bluffs
            (Vector3::new(2215.5181, -2627.8174, 13.5469), 273.7786), // Ocean docks 1
        ...
        let las_venturas_locations = vec![
            ...
            (Vector3::new(1739.6390, 2803.0569, 14.2735), 285.3929), //  Northern housing estate 1
            (Vector3::new(1870.3096, 2785.2471, 14.2734), 42.3102), //  Northern housing estate 2
            ...
            (Vector3::new(2216.5674, 2715.0334, 10.8130), 267.6540), //  Northern industrial estate 2
            (Vector3::new(2101.4192, 2678.7874, 10.8130), 92.0607),  //  Northern near railway line
            (Vector3::new(1951.1090, 2660.3877, 10.8203), 180.8461), //  Northern house 2
            (Vector3::new(1666.6949, 2604.9861, 10.8203), 179.8495), //  Northern house 3
            (Vector3::new(2808.3367, 2421.5107, 11.0625), 136.2060), //  Northern shopping centre
            (Vector3::new(2633.3203, 2349.7061, 10.6719), 178.7175), //  V-Rock
            (Vector3::new(2606.6348, 2161.7490, 10.8203), 88.7508),  //  South V-Rock
            (Vector3::new(2616.5286, 2100.6226, 10.8158), 177.7834), //  North Ammunation 1
            (Vector3::new(2491.8816, 2397.9370, 10.8203), 266.6003), //  North carpark 1
            (Vector3::new(2531.7891, 2530.3223, 21.8750), 91.6686),  //  North carpark 2
            (Vector3::new(2340.6677, 2530.4324, 10.8203), 177.8630), //  North Pizza Stack
            (Vector3::new(2097.6855, 2491.3313, 14.8390), 181.8117), //  Emerald Isle
            (Vector3::new(1893.1000, 2423.2412, 11.1782), 269.4385), //  Souvenir shop
            (Vector3::new(1698.9330, 2241.8320, 10.8203), 357.8584), //  Northern casino
            (Vector3::new(1479.4559, 2249.0769, 11.0234), 306.3790), //  Baseball stadium 1
            ...
            (Vector3::new(1423.9780, 1034.4188, 10.8203), 90.9590),  //  Sumo
            (Vector3::new(1537.4377, 752.0641, 11.0234), 271.6893),  //  Church
            (Vector3::new(1917.9590, 702.6984, 11.1328), 359.2682),  //  Southern housing estate
            ...
            (Vector3::new(2437.9370, 1293.1442, 10.8203), 86.3830), //  Wedding chapel (near Pyramid)
            (Vector3::new(2299.5430, 1451.4177, 10.8203), 269.1287), //  Carpark (near Pyramid)
            ...
            (Vector3::new(2222.1042, 1837.4220, 10.8203), 88.6461), //  Clowns Pocket
            ...
            (Vector3::new(2139.1841, 987.7975, 10.8203), 0.2315),   //  Come-a-lot
            (Vector3::new(1860.9672, 1030.2910, 10.8203), 271.6988), //  Behind 4 Dragons
        ...
        let san_fierro_locations = vec![
            ...
            (Vector3::new(-2458.2000, 134.5419, 35.1719), 303.9446), // hotel
            (Vector3::new(-2796.6589, 219.5733, 7.1875), 88.8288),  // house
            (Vector3::new(-2706.5261, 397.7129, 4.3672), 179.8611), // park
            (Vector3::new(-2866.7683, 691.9363, 23.4989), 286.3060), // house
            (Vector3::new(-2764.9543, 785.6434, 52.7813), 357.6817), // donut shop
            (Vector3::new(-2660.9402, 883.2115, 79.7738), 357.4440), // house
            (Vector3::new(-2861.0796, 1047.7109, 33.6068), 188.2750), //  parking lot
            (Vector3::new(-2629.2009, 1383.1367, 7.1833), 179.7006), // parking lot at the bridge
            ...
            (Vector3::new(-1954.9982, 141.8080, 27.1747), 277.7342), // train station
            ...
            (Vector3::new(-1983.3458, 1117.0645, 53.1243), 271.2390), // church
            (Vector3::new(-2417.6458, 970.1491, 45.2969), 269.3676), // gas station
            (Vector3::new(-2108.0171, 902.8030, 76.5792), 5.7139),  // house
            (Vector3::new(-2097.5664, 658.0771, 52.3672), 270.4487), // random
            (Vector3::new(-2263.6650, 393.7423, 34.7708), 136.4152), // random
            (Vector3::new(-2287.5027, 149.1875, 35.3125), 266.3989), // baseball parking lot
            (Vector3::new(-2039.3571, -97.7205, 35.1641), 7.4744),  // driving school
            (Vector3::new(-1867.5022, -141.9203, 11.8984), 22.4499), // factory
            (Vector3::new(-1537.8992, 116.0441, 17.3226), 120.8537), // docks ship
            (Vector3::new(-1708.4763, 7.0187, 3.5489), 319.3260),   // docks hangar
            (Vector3::new(-1427.0858, -288.9430, 14.1484), 137.0812), // airport
            (Vector3::new(-2173.0654, -392.7444, 35.3359), 237.0159), // stadium
            (Vector3::new(-2320.5286, -180.3870, 35.3135), 179.6980), // burger shot
            (Vector3::new(-2930.0049, 487.2518, 4.9141), 3.8258),   // harbor
        ];
