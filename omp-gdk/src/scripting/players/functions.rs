...
native!(Player_GetNetworkStats, player: struct Player, output: mut str, -> i32);
...
native!(Player_NetStatsGetIpPort, player: struct Player, output: mut str, -> bool);
...
native!(Player_GetDialogData, player: struct Player, dialogid: mut i32, style: mut i32, title: mut str, body: mut str, button1: mut str, button2: mut str, -> bool);
...
native!(Player_GetName, player: struct Player, name: mut str, -> i32);
...
native!(Player_GetAnimationName, index: i32, lib: mut str, name: mut str, -> bool);
...
native!(Player_GetIp, player: struct Player, ip: mut str, -> i32);
...
native!(Player_GPCI, player: struct Player, gpci: mut str, -> bool);
...
native!(Player_GetGameText, player: struct Player, style: i32, message: mut str, time: mut i32, remaining: mut i32, -> bool);
...
native!(Player_GetVersion, player: struct Player, version: mut str, -> i32);
