...
native!(SendClientMessageToAll,colour:isize, message:str, -> bool);
...
native!(SetPlayerColor,playerid:isize, colour:isize, -> bool);
...
native!(SetPlayerMapIcon,playerid:isize, iconID:isize, x:f32,y:f32,z:f32, category:isize, colour:isize, style:isize, -> bool);
...
native!(SetPlayerChatBubble,playerid:isize, text:mut str, text_len:usize, colour:isize, drawdistance:f32, expiretime:isize, -> bool);
...
native!(SetPlayerMarkerForPlayer,playerid:isize, otherid:isize, colour:isize, -> bool);
...
native!(SelectTextDraw,playerid:isize, hoverColour:isize, -> bool);
